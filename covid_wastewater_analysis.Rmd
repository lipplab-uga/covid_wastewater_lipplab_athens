...
```{r}
        ...
        p2 <- p2 %>% plotly::add_segments(x = as.Date("2020-03-14"), xend = ~max(date + 10), y = 3571.4, yend = 3571.4,
                                          opacity = 0.35,
                                          line = list(color = "black", dash = "dash")) %>%
          layout(annotations = list(x = as.Date("2020-03-28"), y = 510000, xref = "x", yref = "y", 
...
p_combined <-
    plotly::subplot(p2,p1, # plots to combine, top to bottom
      nrows = 2,
      heights = c(.5,.5),  # relative heights of the two plots
