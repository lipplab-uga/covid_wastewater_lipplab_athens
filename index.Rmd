...
SARS&#8209;CoV&#8209;2 viral load increased substantially at all three plants, despite high wastewater flows due to heavy rains over the weekend. Typically, the infiltration of rainwater into the sewer lines dilutes the wastewater as it arrives at plant. Despite this dilution effect, concentrations were over 1 million copies per liter at all plants (ranging from 1.13 million copies per liter at WRF C (east side) to 1.79 copies per liter at WRF B (west of Milledge Ave). The overall load for Monday’s sample exceeded that of >97% of samples collected to date.   
