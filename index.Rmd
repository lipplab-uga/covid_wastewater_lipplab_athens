...
The total viral load of SARS-CoV-2 in the sewershed was estimated using data from our weekly wastewater monitoring. Sewage samples are collected weekly from two of the three water reclamation facilities that serve Athens Clarke County (WRF A and WRF B). Samples are tested to detect and measure SARS‑CoV‑2, the virus that causes COVID‑19.  
...
We predict that changes in the concentration of SARS‑CoV‑2 in wastewater will reflect the community trends of circulating COVID‑19 infections. The daily number of newly reported COVID‑19 cases in Athens-Clarke County (purple) appear alongside the 7-day moving average of new cases (yellow). 
