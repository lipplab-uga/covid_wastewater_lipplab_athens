...
**Please Note**.    
In effort to better visualize the SARS&#8209;CoV&#8209;2 data trends more clearly, the y-axis of this figure uses a linear scale instead of a logarithmic scale. This differes from the y-axis scale on the _data trends_ tab of this website. 
