...
lines <- rejoin %>% ggplot() +
  ...
  annotate("pointrange", x = 13.67418, y = 1.5, ymin = 0.95, ymax = 2.05, color = "red", size =1) +
  theme_classic() +
  xlab("Log Viral Load")
...
lines <- lines +   
  ...
  labs(caption = "This Week's Viral Load 4.72e+13 Copies")
...
perc.rank(rejoin$log_sum_copies_both, 13.765)
```
